...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    open var statusBarController : StatusBarAlertController? = nil
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        statusBarController = StatusBarAlertController.init(rootViewController: welcomeVC)
        statusBarController?.statusBarLabel.text = "MESSAGE"
        self.window?.rootViewController = statusBarController
